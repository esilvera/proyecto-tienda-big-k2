                        ...
                        <form onSubmit={addApiProducts} method='POST'>
                            <div className="row form-group">
                                <div className="col-md-4">
                                    <input type="text" className="form-control" id="prod_name" name="prod_name" value={prod_name} maxlength="30" placeholder="Nombre del producto" onChange={handleChange} />
                                </div>
                                <div className="col-md-4">
                                    <input type="text" className="form-control" id="prod_brand" name="prod_brand" value={prod_brand} maxlength="30" placeholder="Marca del producto" onChange={handleChange} />
                                </div>
                            </div>
                            <div className="row form-group">
                            ...
                            <div className="form-group">
                                ...
                                <Link to="/tableproducts" className="btn btn-info" type="submit">Back</Link>
                            </div>
                        </form>
                    </div>
                </div>
